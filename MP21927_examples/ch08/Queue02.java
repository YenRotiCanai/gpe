...
// 主程式
   ...
   int temp;
   System.out.println("以鏈結串列來實作佇列");
   System.out.println("====================================");
   System.out.println("在佇列前端加入第1筆資料，此資料值為1");
   queue.enqueue(1);
   System.out.println("在佇列前端加入第2筆資料，此資料值為3");
   queue.enqueue(3);
   System.out.println("在佇列前端加入第3筆資料，此資料值為5");
   queue.enqueue(5);
   System.out.println("在佇列前端加入第4筆資料，此資料值為7");
   queue.enqueue(7);
   System.out.println("在佇列前端加入第5筆資料，此資料值為9");
   queue.enqueue(9);
   System.out.println("====================================");
   while (true) {
      if (!(queue.front==null)) {
         temp=queue.dequeue();
         System.out.println("從佇列前端依序取出的元素資料值為："+temp);
      }
      else
         break;
   }
